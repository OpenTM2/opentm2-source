...
#ifndef _EqfSharedOnLanMemory_h_
#define _EqfSharedOnLanMemory_h_
...
class EqfSharedOnLanMemory: public OtmSharedMemory
...
/*! \brief Constructors
*/
	EqfSharedOnLanMemory() {};

	EqfSharedOnLanMemory( EqfSharedOnLanMemoryPlugin *pMemoryPlugin, HTM htm, char *pszName );
...
private:
  ...
  EqfSharedOnLanMemoryPlugin *pMemoryPlugin;     // memory plugin for this memory
...
#endif // #ifndef _EqfSharedOnLanMemory_h_