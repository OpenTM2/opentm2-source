...
//+----------------------------------------------------------------------------+
        ...
        #ifndef ADB_SHUTDOWN_H
        #define ADB_SHUTDOWN_H
        ...
        */
        ...
        typedef struct adb_shutdown adb_shutdown_t;
        ...
        /**
         * Constructor for creating adb_shutdown_t
         * @param env pointer to environment struct
         * @return newly created adb_shutdown_t object
         */
         ...
         * @param  _shutdown adb_shutdown_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Getter for user. 
         * @param  _shutdown adb_shutdown_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_shutdown_declare_parent_namespaces(
         ...
         * @param  _shutdown adb_shutdown_t object
         * @param env pointer to environment struct
         * @param shutdown_om_node node to serialize from
         * @param shutdown_om_element parent element to serialize from
        ...
        adb_shutdown_serialize(
            adb_shutdown_t* _shutdown,
            const axutil_env_t *env,
            axiom_node_t* shutdown_om_node, axiom_element_t *shutdown_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_shutdown is a particle class (E.g. group, inner sequence)
        ...
        adb_shutdown_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_shutdown_t object and return the property value.
