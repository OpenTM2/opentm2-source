...
//+----------------------------------------------------------------------------+
        ...
        #include "adb_shutdownResponse.h"
               ...
               /*
                * implmentation of the shutdownResponse|http://webservices.folt.de/ element
                */
       ...
       /************************* Function Implmentations ********************************/
            ...
            const axutil_env_t *env)
        {
            ...
            _shutdownResponse->property_return  = NULL;
        ...
        axis2_char_t* AXIS2_CALL
                        ...
                        const axutil_env_t *env)
                {
                    ...
                    _shutdownResponse->property_return = (axis2_char_t*)NULL;
         ...
         int tag_closed = 0;
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                           ...
                           text_value_1 = _shutdownResponse->property_return;
            ...
            adb_shutdownResponse_set_return(
                    ...
                    const axis2_char_t*  arg_return)
             {
                ...
                _shutdownResponse->property_return = (axis2_char_t *)axutil_strdup(env, arg_return);
                        if(NULL == _shutdownResponse->property_return)
                        {
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _shutdownResponse, AXIS2_FAILURE);
                ...
                if(_shutdownResponse->property_return != NULL)
                {
                   
                   
                        AXIS2_FREE(env-> allocator, _shutdownResponse->property_return);
                     _shutdownResponse->property_return = NULL;
                }
