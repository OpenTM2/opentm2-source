...
if %OTMtype% EQU 2 (
  ...
  call dita.bat  -i OT_TransRef/Opentm2TranslatorsReference.ditamap   -format=html5      -output=out/trans_HTML5     -verbose   -logfile=logs\TransRef_HTML5.log
)
if %OTMtype% EQU 3 (
  echo    Creating HTML Help...
  call dita.bat  -i OT_TransRef/Opentm2TranslatorsReference.ditamap   -format=htmlhelp   -output=out/trans_HTMLHELP  -verbose   -logfile=logs\TransRef_HMLHELP.log
)
echo *-----------------------------------------------------------------------*
