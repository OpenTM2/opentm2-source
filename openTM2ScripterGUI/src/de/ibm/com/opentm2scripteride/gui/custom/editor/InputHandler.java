 ...
 *
 * @author Slava Pestov modified by Tim Reppenhagen 2012
...
public abstract class InputHandler extends KeyAdapter
{
	...
	public static final ActionListener OPEN = new open();
	public static final ActionListener SAVE = new save();
	public static final ActionListener SAVEAS = new saveAs();
	...
	/**
	 * 
	 * Select all class, for the STRG-A Shortcut
	 *
	 */
	...
	/**
	 * 
	 * open class for the STRG O Shortcut
	 *
	 */
	...
	/**
	 * 
	 * Save class for the STRG-S Shortcut
	 *
	 */
	...
	/**
	 * 
	 * SaveAs class for the ALT-S Shortcut
	 *
	 */
	...
	/**
	 * 
	 * Undo class for the STRG-Z Shortcut
	 *
	 */
	public static class undo implements ActionListener
	{
		public void actionPerformed(ActionEvent evt)
		{	
			UndoManager undo = MainApp.getInstance().getActiveEditor().getUndoManager();//EditorConnector.getInstance().undomanager;
			if(undo.canUndo())
			{
				undo.undo();
				//CodeCompleter.getInstance().allcommands();
				//CodeCompleterListFactory.newCodeCompleterList().setListContent(CodeCompleter.getInstance().getAllCommands());
	...
	/**
	 * 
	 * Redo class for the STRG-Y Shortcut
	 *
	 */
	...
	/**
	 * 
	 * Copy class for the STRG-C Shortcut
	 *
	 */
	...
	/**
	 * 
	 * Cut class for the STRG-X Shortcut
	 *
	 */
	...
	/**
	 * 
	 * Paste class for the STRG-V Shortcut
	 *
	 */
	...
	public static class insert_tab implements ActionListener
	{
		public void actionPerformed(ActionEvent evt)
		{
			...
			CodeCompleterList clist = MainApp.getInstance().getMainWindow().getCodeCompleteList();//CodeCompleterListFactory.newCodeCompleterList();
			CodeCompleter cc = CodeCompleter.getInstance();
			if(!clist.isListEmpty() && !clist.isListFull() && cc.getFirstSuggestion() != null){	
				clist.insertListValue(cc.getFirstSuggestion());       
			} else {
				textArea.setSelectedText("\t");
			}	
		}
