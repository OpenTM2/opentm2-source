...
//			Token.NULL : prev.token,line,lineIndex);
		...
		byte token = markTokensImpl(Token.NULL,line,lineIndex);
	...
	public class Token
	{
		...
		/**
		 * VARIABLE token id. This can be used to mark a VARIABLE
		 */
		public static final byte VARIABLE = 3;


		/**
		 * FUNCTIONS token id. This can be used to mark a
		 * FUNCTIONS. 
		 */
		public static final byte FUNCTIONS = 6;

		/**
		 * CONTROLSTRUCTUREs token id. This can be used to mark a
		 * CONTROLSTRUCTURE. 
		 */
		public static final byte BLOCK = 7;

		/**
		 * APICALLS token id. This can be used to mark a
		 * APICALLS.
		 */
		public static final byte APICALLS = 8;
